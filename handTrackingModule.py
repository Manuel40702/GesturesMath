...
class handDetector():
    ...
    def fingersUp(self, myHand):
        ...
        myLm_list = [subList[1:] for subList in lm_list]
        ...
        if self.results.multi_hand_landmarks:
            ...
            if myHandType == "Right":
                if myLm_list[self.tipsIDs[0]][0] > myLm_list[self.tipsIDs[0] - 1][0]:
                    fingers.append(1)
                else:
                    fingers.append(0)
            else:
            ...
            # 4 Fingers
            for id in range(1, 5):
                if myLm_list[self.tipsIDs[id]][1] < myLm_list[self.tipsIDs[id] - 2][1]:
                    fingers.append(1)
                else:
                    fingers.append(0)
        return fingers
